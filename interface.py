...
layout3 = [
    ...
    [sg.Text('', size=(15,1),background_color='#ffffff'),sg.T('Verificação automática',size=(23,1),background_color='#ffffff',text_color='black'),sg.Button('Desativado',visible=True,key='desativado',button_color='red'),sg.Button('Ativado',visible=False,key='ativado',button_color='green')],
    [sg.Text('', size=(15,1),background_color='#ffffff'),sg.T('Notificações push (Windows)',size=(23,1),background_color='#ffffff',text_color='black',visible=False,key='pushtext'),sg.Combo(['Sim','Não'],['Não'],text_color='black',background_color='white',key='notif_push',size=(12),visible=False,readonly=True)],
    [sg.Text('', size=(15,1),background_color='#ffffff'),sg.T('Notificar por email',size=(23,1),background_color='#ffffff',text_color='black',visible=False,key='emailtext'),sg.Combo(['Sim','Não'],['Não'],text_color='black',background_color='white',key='notif_email',size=(12),visible=False,readonly=True)],
    [sg.Text('', size=(30,1),background_color='#ffffff')],
    [sg.Text('', size=(30,1),background_color='#ffffff')],
...
if lay_n == 1:
    janela = sg.Window('PSG', layout=layout1, finalize=True, size=(630,600),icon='img/senacico.ico')
else:
    janela = sg.Window('PSG', layout=layout2, finalize=True, size=(630,600),icon='img/senacico.ico')
...
while True:
    ...
    if event == 'mudartema':
        if mudoutema == True:
            sg.popup('O novo tema será aplicado\nao reiniciar o programa.',title='Aviso',icon='img/senacico.ico')
            configtxt = open('th')
            if configtxt.read() == 'th2' and mudoufixo == False:
                configtxt.close()
                mudoufixo = True
                configtxt = open('th', 'w+')
                configtxt.write('th1')
                configtxt.close()
            elif configtxt.read() == 'th1' and mudoufixo == False:
                configtxt.close()
                mudoufixo = True
                configtxt = open('th', 'w+')
                configtxt.write('th2')
    ...
    if event == 'config':
        ...
        janela1.hide()
        if janopen != True:
            janela2 = sg.Window('PSG', layout=layout3, finalize=True, size=(630,600),background_color='#ffffff',icon='img/senacico.ico')
        janela = janela2
        janela.un_hide()
        janopen = True
        configopen = True
